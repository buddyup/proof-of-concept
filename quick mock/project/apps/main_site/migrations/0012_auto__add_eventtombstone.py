...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EventTombstone'
        db.create_table(u'main_site_eventtombstone', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('recorded_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 12, 18, 0, 0))),
        ))
        db.send_create_signal(u'main_site', ['EventTombstone'])


    def backwards(self, orm):
        # Deleting model 'EventTombstone'
        db.delete_table(u'main_site_eventtombstone')
    ...
    models = {
        u'main_site.datapoint': {
            ...
            'recorded_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 18, 0, 0)'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        u'main_site.eventtombstone': {
            'Meta': {'object_name': 'EventTombstone'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'recorded_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 18, 0, 0)'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
