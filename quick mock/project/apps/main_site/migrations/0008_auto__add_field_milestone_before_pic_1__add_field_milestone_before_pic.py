...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Milestone.before_pic_1'
        db.add_column(u'main_site_milestone', 'before_pic_1',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Milestone.before_pic_2'
        db.add_column(u'main_site_milestone', 'before_pic_2',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Milestone.before_pic_3'
        db.add_column(u'main_site_milestone', 'before_pic_3',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Milestone.after_pic_1'
        db.add_column(u'main_site_milestone', 'after_pic_1',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Milestone.after_pic_2'
        db.add_column(u'main_site_milestone', 'after_pic_2',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Milestone.after_pic_3'
        db.add_column(u'main_site_milestone', 'after_pic_3',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Milestone.before_pic_1'
        db.delete_column(u'main_site_milestone', 'before_pic_1')

        # Deleting field 'Milestone.before_pic_2'
        db.delete_column(u'main_site_milestone', 'before_pic_2')

        # Deleting field 'Milestone.before_pic_3'
        db.delete_column(u'main_site_milestone', 'before_pic_3')

        # Deleting field 'Milestone.after_pic_1'
        db.delete_column(u'main_site_milestone', 'after_pic_1')

        # Deleting field 'Milestone.after_pic_2'
        db.delete_column(u'main_site_milestone', 'after_pic_2')

        # Deleting field 'Milestone.after_pic_3'
        db.delete_column(u'main_site_milestone', 'after_pic_3')
